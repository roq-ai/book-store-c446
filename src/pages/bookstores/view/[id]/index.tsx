...
import { getBookstoreById } from 'apiSdk/bookstores';
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('bookstore', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/bookstores/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="bookstore" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
