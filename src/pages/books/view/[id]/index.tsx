...
import { getBookById } from 'apiSdk/books';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem
                  ...
                  text={
                    data?.published_date
                      ? format(parseISO(data?.published_date as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />

                <FormListItem label="Isbn" text={data?.isbn} />
                ...
                {hasAccess('bookstore', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Bookstore"
                    text={
                      <Link as={NextLink} href={`/bookstores/view/${data?.bookstore?.id}`}>
                        {data?.bookstore?.name}
                      </Link>
                    }
                  />
