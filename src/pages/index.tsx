  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Book Store, your premier online destination for all your reading needs. Where the love for books meets convenience and affordability."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1494809610410-160faaed4de0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxvbmxpbmUlMjBib29rc3RvcmV8ZW58MHx8fHwxNjkzODEyMTkzfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Book Store, your premier online destination for all your reading needs. Where the love for books meets convenience and affordability.`}
            </Text>
            <Box
